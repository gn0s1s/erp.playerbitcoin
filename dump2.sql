...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  KEY `created` (`created`)
) ENGINE=InnoDB AUTO_INCREMENT=925 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cat_bono_valor_nivel` VALUES (1,1,0,21,'RED','ASC'),(2,1,1,21,'RED','ASC'),(3,1,2,0,'RED','ASC'),(4,2,0,30,'RED','ASC'),(5,2,1,1,'RED','ASC'),(6,2,2,2,'RED','ASC'),(7,2,3,3,'RED','ASC'),(8,2,4,9,'RED','ASC'),(9,2,5,15,'RED','ASC'),(10,2,6,30,'RED','ASC');
...
INSERT INTO `cat_bono_condicion` VALUES (1,1,1,3,1,1,2,9,'REC'),(2,2,1,3,1,1,2,2,'REC'),(3,2,1,3,1,1,2,3,'REC'),(4,2,1,3,1,1,2,4,'REC'),(5,2,1,3,1,1,2,5,'REC'),(6,2,1,3,1,1,2,6,'REC'),(7,2,1,3,1,1,2,7,'REC');
...
CREATE TABLE `comision_pasivo` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='bono pasivo';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `comision_bono` VALUES (1,2,1,1,3.125,'4'),(2,860,1,1,3.125,'7'),(3,863,1,1,3.125,'1'),(4,912,1,1,3.125,'5'),(5,2,1,1,5,'6'),(6,2,2,2,0,''),(7,2,2,2,0,''),(8,2,2,2,0,'');
...
CREATE TABLE `bitcoin_stats` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=28 DEFAULT CHARSET=latin1 COMMENT='reporte de bitcoin';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ticket` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=latin1 COMMENT='boleto de apuesta btc';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-03-10 12:09:00
