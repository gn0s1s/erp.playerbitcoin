...
Date.ext = {}, Date.ext.util = {}, Date.ext.util.xPad = function (a, b, c) {
    ...
    a: function (a) {
        ...
        var b = parseInt(Date.ext.formats.W(a), 10), c = new Date("" + a.getFullYear() + "/1/1").getDay(),
            d = b + (c > 4 || 1 >= c ? 0 : 1);
        ...
        var b = a.getTimezoneOffset(), c = Date.ext.util.xPad(parseInt(Math.abs(b / 60), 10), 0),
...
DygraphCanvasRenderer.prototype.attr_ = function (a, b) {
    ...
    var b = a.dygraph, c = a.setName, d = a.strokeWidth, e = b.getOption("strokeBorderWidth", c),
        f = b.getOption("drawPointCallback", c) || Dygraph.Circles.DEFAULT, g = b.getOption("strokePattern", c),
        h = b.getOption("drawPoints", c), i = b.getOption("pointSize", c);
    ...
    if (d) {
        ...
        var f, g = a.drawingContext, h = a.color, i = b.getOption("fillAlpha", c), j = b.getOption("stepPlot", c),
            k = a.points,
            l = Dygraph.createIterator(k, 0, k.length, DygraphCanvasRenderer._getIteratorPredicate(b.getOption("connectSeparatedPoints"))),
            m = 0 / 0, n = 0 / 0, o = [-1, -1], p = new RGBColorParser(h),
    ...
    if (!a.singleSeriesName && 0 === a.seriesIndex) {
        ...
        if (e) for (var f, g, h = a.drawingContext, i = a.plotArea, j = a.allSeriesPoints, k = j.length, l = b.getOption("fillAlpha"), m = b.getOption("stackedGraph"), n = b.getColors(), o = {}, p = k - 1; p >= 0; p--) {
            ...
            if (b.getOption("fillGraph", q)) {
                var r = b.getOption("stepPlot", q), s = n[p], t = b.axisPropertiesForSeries(q),
                ...
                var v, w = j[p],
                    ...
                    y = 0 / 0, z = [-1, -1], A = new RGBColorParser(s),
...
Dygraph.NAME = "Dygraph", Dygraph.VERSION = "1.0.1", Dygraph.__repr__ = function () {
    ...
    var b = Dygraph.zeropad, c = new Date(a), d = "" + c.getFullYear(), e = b(c.getMonth() + 1), f = b(c.getDate()),
        g = "", h = 3600 * c.getHours() + 60 * c.getMinutes() + c.getSeconds();
    ...
    if ("undefined" == typeof b && (b = 0), this.attributes_.getForAxis("logscale", b)) {
        var e = (a - c.y) / c.h, f = Dygraph.log10(d[1]), g = f - e * (f - Dygraph.log10(d[0])),
    ...
    var a = this.attr_("showRoller") ? "block" : "none", b = this.plotter_.area,
        c = {position: "absolute", zIndex: 10, top: b.y + b.h - 25 + "px", left: b.x + 1 + "px", display: a};
    ...
    if (this.isUsingExcanvas_ && this.currentZoomRectArgs_ && Dygraph.prototype.drawZoomRect_.apply(this, this.currentZoomRectArgs_), this.selPoints_.length > 0) {
        ...
        for (c.save(), b = 0; b < this.selPoints_.length; b++) {
            ...
            if (Dygraph.isOK(k.canvasy)) {
                var l = this.attr_("highlightCircleSize", k.name), m = this.attr_("drawHighlightPointCallback", k.name),
    ...
    for (var e = [], f = 0; f < a.length; ++f) {
        var g = a[f], h = b ? g[1][0] : g[1], i = null === h ? null : DygraphLayout.parseFloat_(h),
            j = {x: 0 / 0, y: 0 / 0, xval: DygraphLayout.parseFloat_(g[0]), yval: i, name: c, idx: f + d};
    ...
    var c, d, e, f = [], g = [], h = [], i = {}, j = this.attr_("errorBars"), k = this.attr_("customBars"), l = j || k,
        m = function (a) {
    ...
    for (var b, c, d, e, f, g = function (a) {
        ...
        var j = this.axes_[i], k = this.attributes_.getForAxis("logscale", i),
            l = this.attributes_.getForAxis("includeZero", i), m = this.attributes_.getForAxis("independentTicks", i);
    ...
    if (this.fractions_) {
        ...
        for (e = 0; e < a.length; e++) {
            ...
            if (this.attr_("errorBars")) if (this.attr_("wilsonInterval")) if (n) {
                var r = 0 > q ? 0 : q, s = n, t = l * Math.sqrt(r * (1 - r) / s + l * l / (4 * s * s)),
                    u = 1 + l * l / n;
...
Dygraph.LOG_SCALE = 10, Dygraph.LN_TEN = Math.log(Dygraph.LOG_SCALE), Dygraph.log10 = function (a) {
    ...
    for (var a = document.getElementsByTagName("iframe"), b = 0; b < a.length; b++) {
        var c = a[b], d = Dygraph.findPosX(c), e = Dygraph.findPosY(c), f = c.offsetWidth, g = c.offsetHeight,
    ...
    if (c.dateRange = f[1] - f[0], c.initialLeftmostDate = f[0], c.xUnitsPerPixel = c.dateRange / (b.plotter_.area.w - 1), b.attr_("panEdgeFraction")) {
        var g = b.width_ * b.attr_("panEdgeFraction"), h = b.xAxisExtremes(), i = b.toDomXCoord(h[0]) - g,
            j = b.toDomXCoord(h[1]) + g, k = b.toDataXCoord(i), l = b.toDataXCoord(j);
        c.boundedDates = [k, l];
        var m = [], n = b.height_ * b.attr_("panEdgeFraction");
        for (d = 0; d < b.axes_.length; d++) {
            e = b.axes_[d];
            var o = e.extremeRange, p = b.toDomYCoord(o[0], d) + n, q = b.toDomYCoord(o[1], d) - n,
                r = b.toDataYCoord(p, d), s = b.toDataYCoord(q, d);
            m[d] = [r, s]
        }
        c.boundedValues = m
    }
    ...
    if (c.boundedDates && e > c.boundedDates[1] && (d -= e - c.boundedDates[1], e = d + c.dateRange), b.dateWindow_ = [d, e], c.is2DPan) for (var f = c.dragEndY - c.dragStartY, g = 0; g < b.axes_.length; g++) {
        var h = b.axes_[g], i = c.axes[g], j = f * i.unitsPerPixel, k = c.boundedValues ? c.boundedValues[g] : null,
    ...
    var j = {pageX: g.pageX - i.pageX, pageY: g.pageY - i.pageY}, k = c.initialRange.x[1] - c.initialRange.x[0],
    ...
    if (f) for (g = 0; g < f.length; g++) l.push({v: f[g]}); else {
            ...
            if (n - m >= j / 4) {
                for (var p = n; p >= m; p--) {
                    ...
                    null === o ? o = {
                        tickValue: q,
                        pixel_coord: r
                    } : Math.abs(r - o.pixel_coord) >= k ? o = {tickValue: q, pixel_coord: r} : s.label = "", l.push(s)
                }
                l.reverse()
            }
        }
        if (0 === l.length) {
            ...
            var w, x, y, z, A = Math.ceil(c / k), B = Math.abs(b - a) / A, C = Math.floor(Math.log(B) / Math.log(u)),
                D = Math.pow(u, C);
    ...
    return a.prototype.toString = function () {
        ...
        if (d.getOption("drawXAxis") || d.getOption("drawYAxis")) {
            var e, f, g, h, i, j = a.drawingContext, k = a.canvas.parentNode, l = a.canvas.width, m = a.canvas.height,
                n = function (a) {
                    return {
                        position: "absolute",
            ...
            if (d.getOption("drawYAxis")) {
                if (q.yticks && q.yticks.length > 0) {
                    ...
                    var x = this.ylabels_[0], v = d.getOptionForAxis("axisLabelFontSize", "y"),
    ...
    return a.prototype.select = function (a) {
        ...
        for (h = 0; h < d.length; h++) {
            ...
            if ((0 !== s.yval || q) && Dygraph.isOK(s.canvasy)) {
                g && (f += "<br/>");
                var l = a.getPropertiesForSeries(s.name), t = o[l.axis - 1], u = t("valueFormatter"),
                    v = u(s.yval, t, s.name, a), w = s.name == r ? " class='highlight'" : "";
    ...
    return a.prototype.toString = function () {
        ...
        var a, b, c, d, e, f, g, h, i, j, k, l, m, n, o = this, p = this.isIE_ ? document : window, q = 0, r = null,
            s = !1, t = !1, u = !this.isMobileDevice_ && !this.isUsingExcanvas_, v = new Dygraph.IFrameTarp;
        a = function (a) {
            var b = o.dygraph_.xAxisExtremes(), c = (b[1] - b[0]) / o.canvasRect_.w,
                d = b[0] + (a.leftHandlePos - o.canvasRect_.x) * c, e = b[0] + (a.rightHandlePos - o.canvasRect_.x) * c;
            return [d, e]
        }, b = function (a) {
        ...
        if (a || b) {
            var c = this.getOption_("stepPlot"), d = this.computeCombinedSeriesAndLimits_(), e = d.yMax - d.yMin,
                f = this.bgcanvas_ctx_, g = .5, h = this.dygraph_.xAxisExtremes(), i = Math.max(h[1] - h[0], 1e-30),
                j = (this.canvasRect_.w - g) / i, k = (this.canvasRect_.h - g) / e, l = this.canvasRect_.w - g,
                m = this.canvasRect_.h - g, n = null, o = null;
            f.beginPath(), f.moveTo(g, m);
            for (var p = 0; p < d.data.length; p++) {
                var q = d.data[p], r = null !== q[0] ? (q[0] - h[0]) * j : 0 / 0,
        ...
        var a = this.dygraph_.xAxisExtremes(), b = this.dygraph_.xAxisRange(), c = a[1] - a[0],
            d = Math.max(0, (b[0] - a[0]) / c), e = Math.max(0, (a[1] - b[1]) / c),
            f = this.canvasRect_.x + this.canvasRect_.w * d, g = this.canvasRect_.x + this.canvasRect_.w * (1 - e),
        ...
        var a = this.leftZoomHandle_.width / 2, b = parseFloat(this.leftZoomHandle_.style.left) + a,
