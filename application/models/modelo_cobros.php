	...
	function ConsultarCobrosFecha($inicio, $final){
        $query = "select 
                    ...
                    where
                        ...
                        and c.id_estatus = 3
                        and c.fecha BETWEEN '$inicio 00:00:00' AND '$final 23:59:59'";

        $cobros = $this->db->query($query);
		return $cobros->result();
	}
