...
<li class="banderitas">
    <a href="#" onclick="doGTranslate('es|es');return false;" title="Spanish" class="gflag nturl"
       style="background-position:-600px -200px;"><img src="//gtranslate.net/flags/blank.png" alt="Spanish"/></a>
</li>
...
<script type="text/javascript">
    ...
    function del_spinner_translate(){
        document.getElementById('spinner-translate').remove();
