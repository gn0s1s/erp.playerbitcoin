...
<div id="content"><!-- row -->
    <div class="row"><!-- col -->
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
            <h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --><i class="fa-fw fa fa-file-o"></i> Profit
                Wallet</h1>
        </div><!-- end col -->
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
            <ul id="sparks" class="">
                ...
                <li class="sparks-info">
                    <h5><span class="txt-color-blue"><a
                                    href="/ov/billetera/logout_billetera">sign out of Profit Wallet</a></span></h5>
                </li>
            </ul>
        </div>
    </div><!-- end row --> <!-- row -->
                                ...
                                <div><!-- widget edit box -->
                                    ...
                                    <div class="widget-body">
                                        <ul id="myTab1" class="nav nav-tabs bordered">
                                            <li class="active"><a href="#s1" data-toggle="tab">Chart</a></li>
                                            <li><a href="#s2" data-toggle="tab">Report</a></li>
                                            <li><a href="#s3" data-toggle="tab">Withdrawals</a></li>
                                        </ul>
                                        <div id="myTabContent1" class="tab-content padding-10">
                                            ...
                                            <div class="tab-pane fade" id="s2">
                                                <table id="dt_basic"
                                                    ...
                                                    <tbody><? foreach ($datatable as $key) {
                                                        ?>
                                                        <tr>
                                                        <td><?= $key->fecha ?></td>
                                            ...
                                            <div class="tab-pane fade" id="s3">
                                                <form action="send_mail" method="post" id="contact-form1"
                                                      class="smart-form">
                                                    <header>You dispose from
                                                        $<?= number_format($ganancias, 2) ?></header>
                                                    <fieldset>
                                                        <section class="col col-4">
                                                            <label class="label">Payment Method</label>
                                                            <label class="select">
                                                                <select required
                                                                        name="metodo"><? foreach ($metodo_cobro as $key) {
                                                                        echo '<option value="' . $key->id_metodo . '">' . $key->descripcion . '</option>';
                                                                    } ?></select>
                                                            </label>
                                                        </section>
                                                        <section class="col col-4">
                                                            <label class="label">Payment Methods Hoarding</label>
                                                            <label class="input">
                                                                <input value="1" type="text" readonly/>
                                                            </label>
                                                        </section>
                                                        <section class="col col-2">
                                                            <label class="label">Minor Withdrawal</label>
                                                            <label class="input">
                                                                <input value="1" type="text" readonly/>
                                                            </label>
                                                        </section>
                                                    ...
                                                    <footer>
                                                        <button type="button" onclick="cobrar()"
                                                                class="btn btn-primary">Withdrawal
                                                        </button>
                                                    </footer>
                                                </form>
                                            </div>
                                        </div>
                                    </div><!-- end widget content --></div><!-- end widget div --></div>
                            <!-- end widget --></article>
                    </div>
