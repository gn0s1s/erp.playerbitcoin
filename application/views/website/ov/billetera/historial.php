                                    ...
                                    <div class="widget-body">
                                        <div id="myTabContent1" class="tab-content padding-10">
                                            ...
                                            <table id="dt_basic" class="table table-striped table-bordered table-hover"
                                                ...
                                                <thead>
                                                <tr>
                                                    <th data-hide="expand"><i class="fa fa-fw fa-calendar txt-color-blue
                                                        hidden-md hidden-sm hidden-xs"></i> date
                                                    </th>
                                                    <th>
                                                    ...
                                                    <th data-hide="phone,tablet">
                                                        <i class="fa fa-fw fa-money text-muted hidden-md hidden-sm hidden-xs"></i>Payment
                                                        method
                                                    </th>
                                                    <th data-hide="phone,tablet">
                                                    ...
                                                    <th data-hide="phone,tablet">
                                                        <i class="fa fa-fw fa-credit-card text-muted hidden-md hidden-sm hidden-xs"></i>Account
                                                        number
                                                    </th>
                                                    <th>
                                                        <i class="fa fa-fw fa-bank text-muted hidden-md hidden-sm hidden-xs"></i>
                                                        Bank
                                                    </th>
                                                    <th data-hide="phone,tablet">
                                                        <i class="fa fa-fw fa-btc text-muted hidden-md hidden-sm hidden-xs"></i>
                                                        Wallet address
                                                    </th>
                                                    <th>Status</th>
                                                </tr>
