                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 profile-pic">
                                            <img class="<?php if ($actividad) echo "online"; ?>" src="<?= $user ?>"
                                                 alt="demo user">
                                            <div class="padding-10">
                                                <a style="padding: 6px 2rem 6px 6px;" href="/ov/networkProfile/photo"><i
                                                            class="fa fa-camera fa-2x fa-fw fa-lg"></i></a>
                                                <br><br>
                                        ...
                                        <div class="col-sm-4">
                                            <h1><?= $usuario[0]->nombre ?> <span
                                                        class="semi-bold"><?= $usuario[0]->apellido ?></span>
                                                <br>
                                                <small> <?php //echo $nivel_actual_red?></small>
                                            </h1>
                                            ...
                                            <ul class="list-unstyled ">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="<?= $link_personal; ?>"
                                                       target="_blank"><?= $link_personal; ?></a>
                                                    <hr/>
                                                </li>
                                                <li>
                                                    <p class="text-muted">
                                                ...
                                                <li>
                                                    <p class="text-muted">
                                                        <i class="fa fa-calendar"></i>&nbsp;&nbsp;<span
                                                                class="txt-color-darken">Last session: <a
                                                ...
                                                <li>
                                                    <?php if ($id_sponsor && $name_sponsor) {
                                                        if (($id_sponsor[0]->id_usuario != 1)) {
                                                            ...
                                                            <?= $name_sponsor[0]->nombre ?>
                                                            <?= $name_sponsor[0]->apellido ?>, ID
                                                            <?= $id_sponsor[0]->id_usuario ?>
                                                            <br/>
                                                        ...
                                                        if ($isTitulo) :
                                                            ...
                                                            <ul id="sparks" class="">
                                                                <li class="sparks-info">
                                                                    <h5>Ranking<span class="txt-color-yellow"><i
                                                                                    class="fa fa-trophy fa-2x"></i><?= $titulo; ?> </span>
                                                                    </h5>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <ul class="list-inline friends-list">
                                                <li class="hide"><span
                                                            class="font-md"><i>On Week :</i></span>
                                                    <?= intval($puntos_semana) ?>
                                                </li>
                                                <li class="hide"><span
                                                            class="font-md"><i>On Month :</i></span>
                                                    <?= intval($puntos_mes) ?>
                                                </li>
                                                <li><span class="font-md"><i>Total :</i></span>
                                                    <?= intval($balance) ?>
                                                </li>
                                            </ul>
                                            <h1>
                                                <small>Purchases on the Network</small>
                                                <i class='fa fa-sitemap'></i></h1>
                                            <ul class="list-inline friends-list">
                                                <li>
                                                    <span class="font-md"><i>On Week :</i></span>
                                                    <?= $puntos_red_semana ?>
                                                </li>
                                                <li>
                                                    <span class="font-md"><i>On Month :</i></span>
                                                    <?= $puntos_red_mes ?>
                                                </li>
                                                <li><span class="font-md"><i>Total :</i></span>
                                                    <?= $puntos_red_total ?>
                                            ...
                                            <div class="col-md-12">
                                                <a href="/play/dashboard">
                                                    <div id="play-boton"
                                                        ...
                                                        <h3>
                                                            <i class="fa fa-btc "></i> Let's Play</h3>
                                                    </div>
                                                </a>
                                            </div>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div role="widget"
                                        ...
                                        <header role="heading">
                                            <div role="menu"><a data-toggle="dropdown" href="javascript:void(0);"></a>
                                            ...
                                            <span class="widget-icon"> <i
                                                        class="fa fa-comments txt-color-white"></i> </span>
                                            <h2>Notifications </h2>
                                            <div role="menu">
                                                    ...
                                                    <ul class="dropdown-menu pull-right js-status-update">
                                                        <li>
                                                            <a href="javascript:void(0);"><i
                                                                        class="fa fa-circle txt-color-green"></i> Online</a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:void(0);"><i
                                                                        class="fa fa-circle txt-color-red"></i> Busy</a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:void(0);"><i
                                                                        class="fa fa-circle txt-color-orange"></i> Away</a>
                                                        </li>
                                                        <li class="divider"></li>
                                                        <li>
                                                            <a href="javascript:void(0);"><i
                                                                        class="fa fa-power-off"></i> Log Off</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div style="display: block;" role="content">
                                            ...
                                            <div class="widget-body widget-hide-overflow no-padding">
                                                ...
                                                <div id="chat-container">
                                                    <span>
<i class="fa fa-user"></i><b>!</b></span>
                                                    <div class="chat-list-footer">
                                                        <div class="control-group">
                                                            <form class="smart-form">
                                                                <section>
                                                                    <label class="input">
                                                                        <input id="filter-chat-list"
                                                ...
                                                <div id="chat-body" class="chat-body custom-scroll">
																<span id="" class="activity-dropdown"> <i
                                                                            class="fa fa-user"></i> My Network Members
                                                    ...
                                                    <ul>
                                                                ...
                                                                <li class="message">
                                                                    ...
                                                                    <div class="message-text">
                                                                        ...
                                                                        <a href="javascript:void(0);"
                                                                           class="username"><?= $notify->nombre; ?> </a>
                                                                        <?= $notify->descripcion; ?>
                                                                    </div>
                                                                </li>
                                                                <?php
                                                        ...
                                                        foreach ($cuentasPorPagar as $cuenta) {
                                                            ?>
                                                            <li class="message">
                                                                <img src="/template/img/notificaciones/icon-deuda.png"
                                                                     style="width: 5rem;" class="online" alt="">
                                                                <div class="message-text">
                                                                    <time>
                                                                        <?= $cuenta->fecha; ?>
                                                                    </time>
                                                                    <a href="/ov/email" class="username">Submit payment
                                                                        voucher</a>
                                                                    <br>
                                                                    ...
                                                                    <?php
                                                                    if ($cuenta->otro)
                                                                    ?> <span>Titular:	<b><?= $cuenta->otro; ?> </b>,</span><br>
                                                                    <?php
                                                                    if ($cuenta->clabe)
                                                                    ?>
                                                                    <span>Clabe:	<b><?= $cuenta->clabe; ?> </b>,</span><br>
                                                                    <?php
                                                                    if ($cuenta->swift)
                                                                    ?>
                                                                    <span>SWIFT:	<b><?= $cuenta->swift; ?> </b>,</span><br>
                                                                    <?php
                                                                    if ($cuenta->dir_postal)
                                                                    ?>
                                                                    <span>Postal address  :<b><?= $cuenta->dir_postal; ?> </b>,</span><br>
                                                                    <?php
                                                                    ?> <span>Valor:	<b> $
                                                                            <?= $cuenta->valor; ?> </b>,</span>
                                                                </div>
            ...
            <div class="well" style="">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <?php }
                        $permiso = $ci->model_permissions->check($id, 'afiliar'); //foto
                        if ($permiso) {
                            ?>
                            <div class="col-sm-6">
                                <a href="/ov/perfil_red/afiliar?tipo=1"> <!-- perfil_red/foto -->
                                    <div class="well well-sm txt-color-white text-center link_dashboard"
                                        ...
                                        <!-- fa-camera -->
                                        <h5>
                                            <i class="fa fa-edit "></i> Affiliate</h5> <!-- Foto -->
                                    </div>
                                </a>
                            </div>
                        <?php } ?>
                            ...
                            <div class="col-sm-6">
                                <a href="reports"> <!-- /ov/perfil_red/afiliar?tipo=1 -->
                                    <div class="well well-sm txt-color-white text-center link_dashboard"
                                         style="background:<?= $style[0]->btn_2_color ?>">
                                        <h5>
                                            <i class="fa fa-table "></i> Reports</h5> <!-- Afiliar -->
                                    </div>
                                </a>
                            </div>
                        <?php }
                            ...
                            <div class="col-sm-6">
                                <a href="/ov/red/index">
                                    <div class="well well-sm txt-color-white text-center link_dashboard"
                                         style="background:<?= $style[0]->btn_1_color ?>;">
                                        <h5>
                                            <i class="fa fa-sitemap "></i> Network</h5>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <a href="/shoppingcart">
                                    <div class="well well-sm txt-color-white text-center link_dashboard"
                                         style="background:<?= $style[0]->btn_2_color ?>">
                                        <h5>
                                            <i class="fa fa-shopping-cart "></i> Deposits</h5>
                                    </div>
                                </a>
                            </div>
                        <?php } ?>
                            ...
                            <div class="col-sm-6">
                                <a href="accountStatus">
                                    <div class="well well-sm txt-color-white text-center link_dashboard"
                                         style="background:<?= $style[0]->btn_1_color ?>;">
                                        <h5>
                                            <i class="fa fa-money "></i> Profit Statement</h5>
                                    </div>
                                </a>
                            </div>
                        <?php } ?>
                            ...
                            <div class="col-sm-6">
                                <a href="/ov/tickets"> <!-- compras/reportes -->
                                    <div class="well well-sm txt-color-white text-center link_dashboard"
                                         style="background:<?= $style[0]->btn_1_color ?>;">
                                        <h5>
                                            <i class="fa fa-ticket "></i> Tickets/Cupons</h5> <!-- Reportes -->
                                    </div>
                                </a>
                            </div>
                        <?php } ?>
                            ...
                            <div class="col-sm-6">
                                <a href="wallet">
                                    <div class="well well-sm txt-color-white text-center link_dashboard"
                                         style="background:<?= $style[0]->btn_2_color ?>;">
                                        <h5>
                                            <i class="fa fa-dollar "></i> Profit Wallet</h5>
                                    </div>
                                </a>
                            </div>
                        <?php } ?>
                                     ...
                                     <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                         <a href="surveys">
                                             <div class="well well-sm txt-color-white text-center link_dashboard" style="background:<?= $style[0]->btn_1_color ?>;">
                                                 <h5>
<i class="fa fa-file-text-o "></i> Surveys</h5>
                                             </div>
                                         </a>
                                     </div>
                                 <?php }
                    $permiso = $ci->model_permissions->check($id, 'archivero');
                    if ($permiso) {
                        ?>
                                     <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                         <a href="archive">
                                             <div class="well well-sm txt-color-white text-center link_dashboard" style="background:<?= $style[0]->btn_2_color ?>">
                                                 <h5>
<i class="fa fa-archive "></i> Files</h5>
                                             </div>
                                         </a>
                                     </div>
                                 <?php } ?>
                        ...
                        ?>
                                     <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                         <a href="board">
                                             <div class="well well-sm txt-color-white text-center link_dashboard" style="background:<?= $style[0]->btn_2_color ?>;">
                                                 <h5>
<i class="fa fa-cogs "></i> Template</h5>
                                             </div>
                                         </a>
                                     </div>
                                 <?php }
                    $permiso = $ci->model_permissions->check($id, 'compartir');
                    if ($permiso) {
                        ?>
                                     <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                                         <a href="share">
                                             <div class="well well-sm txt-color-white text-center link_dashboard" style="background:<?= $style[0]->btn_1_color ?>">
                                                 <h5>
<i class="fa  fa-folder-open-o  "></i> SharePoint</h5>
                                             </div>
                                         </a>
                                     </div>
                                 <?php } ?>
                                    ...
                                    <div class="col-sm-6">
                                        <a href="cgeneral/autoresponder">
                                            <div class="well well-sm txt-color-white text-center link_dashboard"
                                                 style="background:<?= $style[0]->btn_2_color ?>">
                                                <h5>
                                                    <i class="fa fa-globe "></i> Autoresponder</h5>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-sm-6">
                                            ...
                                            <div class="well well-sm txt-color-white text-center link_dashboard"
                                                ...
                                                <h5>
                                                    <i class="fa fa-envelope fa-2x"></i>&nbsp;&nbsp;<i
                                                            class="fa fa-sitemap "></i> Affiliate Banner</h5>
                                            </div>
                                        </a>
                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <a href="email">
                                                <div class="well well-sm txt-color-white text-center link_dashboard"
                                                     style="background:<?= $style[0]->btn_2_color ?>">
                                                    <h5>
                                                        <i class="fa fa-envelope "></i> E-mail</h5>
                                                </div>
                                            </a>
                                        </div>
                        ...
                        <div class="well">
                            <div class="row">
                                <fieldset>
                                    ...
                                    <div class="col-sm-6">
                                        <a href="/ov/cgeneral/winners"><!--  -->
                                            <div class="well well-sm txt-color-white text-center link_dashboard"
                                                 style="background:<?= $style[0]->btn_1_color ?>">
                                                <h5>
                                                    <i class="fa fa-trophy "></i> Winners</h5>
                                            </div>
                                        </a>
                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <a href="information">
                                                <div class="well well-sm txt-color-white text-center link_dashboard"
                                                     style="background:<?= $style[0]->btn_2_color ?>">
                                                    <h5>
                                                        <i class="fa fa-info "></i> Information</h5>
                                                </div>
                                            </a>
                                        </div>
                                    <?php }
                                    $permiso = $ci->model_permissions->check($id, 'presentaciones');
                                    if ($permiso) {
                                        ?>
                                        <div class="hide col-sm-6">
                                            <a href="presentations">
                                                <div class="well well-sm txt-color-white text-center link_dashboard"
                                                     style="background:<?= $style[0]->btn_1_color ?>;">
                                                    <h5>
                                                        <i class="fa fa-desktop "></i> Slideshow</h5>
                                                </div>
                                            </a>
                                        </div>
                                    <?php }
                                    $permiso = $ci->model_permissions->check($id, 'e_books');
                                    if ($permiso) {
                                        ?>
                                        <div class="col-sm-6">
                                            <a href="ebooks">
                                                <div class="well well-sm txt-color-white text-center link_dashboard"
                                                     style="background:<?= $style[0]->btn_2_color ?>">
                                                    <h5>
                                                        <i class="fa fa-book "></i> E-books</h5>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="hide col-sm-6">
                                            <a href="downloads">
                                                <div class="well well-sm txt-color-white text-center link_dashboard"
                                                     style="background:<?= $style[0]->btn_1_color ?>">
                                                    <h5>
                                                        <i class="fa fa-download "></i> Downloadable</h5>
                                                </div>
                                            </a>
                                        </div>
                                    ...
                                    <div class="hide col-sm-6">
                                        <a href="events">
                                            <div class="well well-sm txt-color-white text-center link_dashboard"
                                                 style="background:<?= $style[0]->btn_1_color ?>;">
                                                <h5>
                                                    <i class="fa fa-calendar "></i> Events</h5>
                                            </div>
                                        </a>
                                    </div>
                                <?php }
                                $permiso = $ci->model_permissions->check($id, 'noticias');
                                if ($permiso) {
                                    ?>
                                    <div class="hide col-sm-6">
                                        <a href="news">
                                            <div class="well well-sm txt-color-white text-center link_dashboard"
                                                 style="background:<?= $style[0]->btn_2_color ?>">
                                                <h5>
                                                    <i class="fa fa-bullhorn "></i> News</h5>
                                            </div>
                                        </a>
                                    </div>
                                <?php }
                                $permiso = $ci->model_permissions->check($id, 'videos');
                                if ($permiso){
                                ?>
                                <div class="hide col-sm-6">
                                    <a href="videos">
                                        <div class="well well-sm txt-color-white text-center link_dashboard"
                                             style="background:<?= $style[0]->btn_1_color ?>;">
                                            <h5>
                                                <i class="fa fa-file-video-o "></i> Videos</h5>
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <div class="hide col-sm-6">
                                        <a href="statistics">
                                            <div class="well well-sm txt-color-white text-center link_dashboard"
                                                 style="background:<?= $style[0]->btn_2_color ?>">
                                                <h5>
                                                    <i class="fa fa-bar-chart-o "></i> Statistics</h5>
                                            </div>
                                        </a>
                                    </div>
                                <?php } ?>
                                        ...
                                        <div class="col-sm-2">
                                            <a href="coupons"><!--   escuela_negocios/promociones -->
                                                <div class="well well-sm txt-color-white text-center link_dashboard"
                                                     style="background:<?= $style[0]->btn_2_color ?>">
                                                    <h5>
                                                        <i class="fa fa-gift  "></i> Calculated Commissions</h5>
                                                </div>
                                            </a>
                                        </div>
                                    <?php } ?>
                                        ...
                                        <div class="col-sm-2">
                                            <a href="acknowledgments">
                                                <div class="well well-sm txt-color-white text-center link_dashboard"
                                                     style="background:<?= $style[0]->btn_2_color ?>">
                                                    <h5>
                                                        <i class="fa fa-star "></i> Reconocimientos</h5>
                                                </div>
                                            </a>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <div class="col-sm-2">
                                        <a href="javascript:void(0);">
                                            <div class="well well-sm txt-color-white text-center link_dashboard"
                                                 style="background:<?= $style[0]->btn_1_color ?>;">
                                                <h5>
                                                    <i class="fa fa-gift "></i> Promociones</h5>
                                            </div>
                                        </a>
                                    </div>
                                        ...
                                        <div class="col-sm-2">
                                            <a href="personalWeb">
                                                <div class="well well-sm txt-color-white text-center link_dashboard"
                                                     style="background:<?= $style[0]->btn_2_color ?>">
                                                    <h5>
                                                        <i class="fa fa-globe "></i> Web Personal</h5>
                                                </div>
                                            </a>
                                        </div>
                                    <?php } ?>
                                        ...
                                        <div class="col-sm-2">
                                            <a href="chat">
                                                <div class="well well-sm txt-color-white text-center link_dashboard"
                                                     style="background:<?= $style[0]->btn_1_color ?>;">
                                                    <h5>
                                                        <i class="fa fa-weixin "></i> Chat my Network</h5>
                                                </div>
                                            </a>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <div class="col-sm-2">
                                        <a href="suggestion">
                                            <div class="well well-sm txt-color-white text-center link_dashboard"
                                                 style="background:<?= $style[0]->btn_2_color ?>">
                                                <h5>
                                                    <i class="fa fa-send "></i> Suggestions</h5>
                                            </div>
                                        </a>
                                    </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <a href="#">
                                        <div class="well well-sm txt-color-white text-center link_dashboard"
                                             style="background:<?= $style[0]->btn_1_color ?>">
                                            <h5>
                                                <i class="fa fa-video-camera "></i> Vídeollamadas</h5>
                                        </div>
                                    </a>
                                </div>
                            ...
                            if ($permiso) {
                                ...
                                <div class="col-sm-6">
                                    <a href="javascript:void(0);"> <!-- compras/reportes -->
                                        <div class="well well-sm txt-color-white text-center link_dashboard"
                                             style="background:#c0c0c0;<? //=$style[0]->btn_1_color
                                             ?>;">
                                            <!-- fa-table -->
                                            <h5>
                                                <i class="fa fa-ticket "></i> Tickets</h5> <!-- Reportes -->
                                        </div>
                                    </a>
                                </div>
                            <?php } ?>
                            ...
                            <div class="col-sm-2">
                                <a href="javascript:void(0);">
                                    <div class="well well-sm txt-color-white text-center link_dashboard"
                                         style="background:<?= $style[0]->btn_2_color ?>;">
                                        <h5>
                                            <i class="fa fa-stack-overflow  "></i> Revista Digital</h5>
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-2">
                                <a href="cgeneral/redes_afiliado_chat?id=red_personal">
                                    <div class="well well-sm txt-color-white text-center link_dashboard"
                                         style="background:<?= $style[0]->btn_1_color ?>;">
                                        <h5>
                                            <i class="fa fa-weixin "></i> Chat</h5>
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-2">
                                <a href="javascript:void(0);">
                                    <div class="well well-sm txt-color-white text-center link_dashboard"
                                         style="background:<?= $style[0]->btn_2_color ?>">
                                        <h5>
                                            <i class="fa fa-mortar-board "></i> Aula Virtual</h5>
                                    </div>
                                </a>
                            </div>
                            <div class="col-sm-2">
