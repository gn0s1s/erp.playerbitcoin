                    ...
                    <form class="smart-form" id="reporte-form" method="post">
                        <div class="row">
                            <section class="col col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                ...
                                <label class="select">
                                    <select id="tipo-reporte">
                                        ...
                                        <option onclick="tipo_reporte()" value="11">my Network inactived Members
                                        </option>
                            ...
                            <section class="col col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                <label class="input">
                                    <a id="genera-reporte"
                                       class="btn btn-primary col-xs-12 col-lg-12 col-md-12 col-sm-12">Generate</a>
                                </label>
                            </section>
                        </div>
                        <div class="row" id="row-print" style="display: none;">
                            ...
                            <section class="col col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <label class="input">
                                    <a id="imprimir-1" onclick="window.print()"
                                       class="btn btn-success col-xs-12 col-lg-12 col-md-12 col-sm-12 hide"><i
                    ...
                    <form class="smart-form" id="reporte-form" method="post">
                        ...
                        <div class="row">
                            ...
                            <section class="col col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                ...
                                <label class="input">
                                    <a id="imprimir-2" onclick="window.print()"
                                       class="btn btn-success col-xs-12 col-lg-12 col-md-12 col-sm-12"><i
                                                class="fa fa-print"></i>&nbsp;Imprimir</a>
                                </label>
                            </section>
...
<script type="text/javascript">
    ...
    function validarsifecha(tipo, inicio, fin) {
        console.log('validarsifecha');
        var tiposfecha = [2, 3, 4, 5, 7, 8, 12];
        for (var i = 0; i < tiposfecha.length; i++) {
            var tipoFecha = tiposfecha[i];
            if (tipo == tipoFecha) {
                var nofin = fin == '';
                var noInicio = inicio == '';
                return (noInicio || nofin) ;
            }
        }
    }
    ...
    $("#genera-reporte").click(function () {
        ...
        if (!validarsifecha(tipo, inicio, fin)) {
            ...
            $.ajax({
                ...
                success: function (msg) {
                    console.log('reportes_tipo:done');
                    $("#reporte_div").html(msg);
                    setTableConfig();
                    FinalizarSpinner();
                }
