    ...
    <div class="row">
        <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
            <h1 class="page-title txt-color-blueDark"><!-- PAGE HEADER --> <a class="backHome" href="/bo"><i
                            class="fa fa-home"></i> Menu</a> <span>&gt; <a href="/bo/configuracion/">Settings</a> &gt; Networks</span>
            </h1>
        </div>
    </div>
                                ...
                                <div class="contenidoBotones">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-11 col-sm-12 col-md-6 col-lg-8 link">
                                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 link"><a
                                                        href="/bo/tipo_red/crear_red">
                                                    <div class="minh well well-sm txt-color-white text-center link_dashboard"
                                                        ...
                                                        <h1>Add</h1>
                                                        <h1>Network</h1><br></div>
                                                </a></div>
                                            <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 link"><a
                                                        href="/bo/tipo_red/mostrar_redes">
                                                    <div class="minh well well-sm txt-color-white text-center link_dashboard"
                                                         style="background:<?= $style[0]->btn_1_color ?>"><i
                                                                class="fa fa-list-alt fa-3x"></i>
                                                        <h1>List</h1>
                                                        <h1>Networks</h1><br></div>
                                                </a></div><!-- <div class="col-xs-12 col-sm-5 col-md-5 col-lg-3 link">
