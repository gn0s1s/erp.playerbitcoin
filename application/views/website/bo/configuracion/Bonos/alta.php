...
foreach ($rangosActivos as $categoria) {
    $id_rango = $categoria->id_rango;
    $nombre_rango = $categoria->nombre_rango;
    $rangos = $rangos . "<option value=\'" . $id_rango . "\'>" . $nombre_rango . "</option>";
}
?>
                                    ...
                                    <div>
                                        <div class="widget-body">
                                            <form id="bonos" action="/bo/bonos/nuevo_bono" method="POST" role="form">
                                                <legend>Nuevo Bono</legend>
                                                <br>

                                                <label style="margin: 1rem;" class="input"><i
                                                            class="icon-prepend fa fa-check-circle-o"></i>
                                                    <input id="nombre" class="form-control" name="nombre"
                                                           style="width:200px; height:30px;" placeholder="Name"
                                                           required="" type="text">
                                                </label>
                                                <label style="margin: 1rem;">
                                                    <textarea id="mymarkdown" name="descripcion" class="form-control"
                                                              name="desc" size="20" cols="20" rows="10"
                                                ...
                                                <div style="margin: 1rem;">
                                                    <h4>Frecuencia</h4>
                                                    <label class="radio">
                                                        <input value="SIN" name="frecuencia" placeholder="frecuencia"
                                                               type="radio">
                                                    ...
                                                    <label class="radio">
                                                        ...
                                                        <i></i>Anual</label>
                                                    <label class="radio">
                                                        <input checked="" value="MES" name="frecuencia"
                                                               placeholder="frecuencia" type="radio">
                                                        <i></i>Mensual</label>
                                                    <label class="radio">
                                                    ...
                                                    <br><br>
                                                    <p>Nota: the remanente guarda un historial of the resta of the pata
                                                        mas debil con the pata mas fuerte & guarda the resultado para
                                                        the proximo corte.</p>
                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col col-lg-2 col-xs-2">
                                                                    <a style="cursor: pointer;" onclick="add_rango()">
                                                                        Add Condicion <i class="fa fa-plus"></i></a>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-12 col-md-2 col-lg-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control spinner-both"
                                                                               id="mesDesdeAfiliacion"
                                                                               name="mesDesdeAfiliacion" value="0">
                                                                    </div>
                                                                </div>
                                                                <div class="col-sm-12 col-md-2 col-lg-2">
                                                                </div>
                                                                <div class="col-sm-12 col-md-2 col-lg-2">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control spinner-both"
                                                                               id="mesDesdeActivacion"
                                                                               name="mesDesdeActivacion" value="0">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </fieldset>
                                                        <br>
                                                        <p>Nota: Intervalo of tiempo desde que the afiliado esta
                                                            afiliado on the Network.</p>
                                                        <br>
                                                        <label style="margin: 1rem;"><h2>Fecha of Activacion</h2>
                                                        </label>
                                                        <div style="margin: 1rem;">
                                                            <section class="col col-2">
                                                                <label class="input"> <i
                                                                    ...
                                                                    <input required id="inicio" value="" type="text"
                                                                           name="inicio" placeholder="Fecha of Inicio">
                                                                </label>
                                                            </section>
                                                            <section class="col col-2">
                                                                <label class="input"> <i
                                                                            class="icon-prepend fa fa-calendar"></i>
                                                                    <input required id="fin" value="" type="text"
                                                                           name="fin" placeholder="Fecha of Fin">
                                                                </label>
                                                            </section>
                                                            <br><br><br>
                                                            <h4></h4>

                                                            <header>Calculated Commissions Por Nivel</header>
                                                            <br><br>
                                                            <div class="row">
                                                                <div class="col col-lg-3 col-xs-2">
                                                                </div>
                                                            ...
                                                            <div class="row" id="niveles">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col col-lg-2 col-xs-2">
                                                                        <a style="cursor: pointer;"
                                                                           onclick="add_nivel()"> Add Nivel <i
                                                                                    class="fa fa-plus"></i></a>
                                                                        <a style="cursor: pointer;"
                                                                           onclick="reload_niveles()">&nbsp&nbsp&nbsp<i
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col col-lg-2">
                                                                        ...
                                                                        <label style="margin: 0.2rem;" class="input"><i
                                                                                    class="icon-prepend fa fa-sitemap"></i>
                                                                            <input class="form-control"
                                                                                   style="width:200px; height:30px;"
                                                                                   name="id_niveles_bonos[]" size="20"
                                                                                   value="0" required type="number"
                                                                                   readonly>
                                                                        </label>
                                                                    </div>
                                                                    <div class="col col-lg-1">
                                                                    ...
                                                                    <div class="col col-xs-12 col-sm-6 col-lg-2"
                                                                        ...
                                                                        <label class="select">Forma of Repartir
                                                                            <select name="verticalidad_red[]">
                                                                                <option value="ASC">$ Hacia Arriba
                                                                                </option>
                                                                                <option value="DESC">$ Hacia Abajo
                                                                                </option>
                                                                                <option value="PASC">%(Puntos) Hacia
                                                                                    Arriba
                                                                                </option>
                                                                                <option value="RDESC">%(Puntos)Residual
                                                                                    Abajo
                                                                                </option>
                                                                            </select>
                                                                        </label>
                                                                    ...
                                                                    <div class="col col-xs-12 col-sm-6 col-lg-2"
                                                                        ...
                                                                        <label class="select">Condición Red
                                                                            <select name="condicion_red[]">
                                                                                <option value="RED">Toda the Network
                                                                                </option>
                                                                                <option value="DIRECTOS">Directos
                                                                                    Afiliado
                                                                                </option>
                                                                            </select>
                                                                        </label>
                                                                    ...
                                                                    <div class="col col-lg-2">
                                                                        <label style="margin: 2rem;" class="input"><i
                                                                                    class="icon-prepend fa fa-money"></i>
                                                                            <input class="form-control"
                                                                                   style="width:200px; height:30px;"
                                                                                   name="valor[]" size="20"
                                                                                   placeholder="Valor del Bono" required
                                                            ...
                                                            <br>
                                                            <button style="margin: 1rem;margin-bottom: 4rem;"
                                                                    type="input" class="btn btn-success">Crear
                                                            </button>
                                                            <br>
                                                            <p style="margin: 1.5rem;">Nota:
                                                                <br><b>Forma of Repartir commission :</b>
                                                                <br>&nbsp&nbsp-($ Hacia Arriba) Monto on $ que se
                                                                reparte del afiliado hacia arriba of su red.
                                                                <br>&nbsp&nbsp-($ Hacia Abajo) Monto on $ que se reparte
                                                                del afiliado hacia abajo of su red.
                                                                <br>&nbsp&nbsp-(% Puntos Hacia Arriba) Se toma the
                                                                porcentaje of los puntos totales que se va a entragar.
                                                                <br>&nbsp&nbsp-(% Puntos Residual Abajo) Bono a the
                                                                medida que reparte dividiendo the total of Points of
                                                                commissions dividiendo the numero of igualaciones of
                                                                Network.
                                                                <br><b>Condición Red:</b>
                                                                <br>&nbsp&nbsp-(Directos Afiliados) Selecciona solo los
                                                                directos del afiliado.
                                                                <br>&nbsp&nbsp-(Toda the Network) Selecciona todos los
                                                                afiliados of Network Directos e Indirectos.
                                                            </p>
