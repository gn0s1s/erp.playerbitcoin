                    ...
                    <form class="smart-form" id="reporte-form" method="post">
                        <div class="row">
                            ...
                            <section class="col col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <label class="input">
                                    <a id="genera-reporte"
                                       class="btn btn-success col-xs-12 col-lg-12 col-md-12 col-sm-12">Generar
                                        Reporte</a>
                                </label>
                            </section>
                            <section class="col col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <label class="input">
                                    <a id="imprimir-2" onclick="reporte_excel()"
                                       class="btn btn-primary col-xs-12 col-lg-12 col-md-12 col-sm-12"><i
                                                class="fa fa-print"></i>&nbsp;Crear excel</a>
                                </label>
                            </section>
                        </div>
