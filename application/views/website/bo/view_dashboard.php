    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="well well-sm">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-4" style="margin-top: 8rem;">
                        ...
                        <div class="col-md-12">
                            <a href="/bo/bonos/historial">
                                <div id="play-boton"
                                    ...
                                    <h3>
                                        <i class="fa fa-btc "></i> See Winners</h3>
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-8">
                        ...
                        <div class="well" style="box-shadow: 0px 0px 0px !important;border-color: transparent;">
                            <fieldset>
                                <legend>
                                    <b>Integral Network System Administrator</b>
                                </legend>
                                <div class="row">
                                    <div class="col-sm-4">
