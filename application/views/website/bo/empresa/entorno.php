    ...
    <div class="row">
        <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
            <h1 class="page-title txt-color-blueDark"><a class="backHome" href="/bo"><i class="fa fa-home"></i> Menu</a>
                ...
                <span>>Activity Settings</span></h1>
        </div>
    </div>
        ...
        <div class="row"><!-- new  COL START -->
            <article class="col-sm-12 col-md-12 col-lg-12"><!-- Widget ID (each widget will need unique ID)-->
                <div class="jarviswidget" id="wid-id-1"
					...
					-->
                    <header><span class="widget-icon"><i class="fa fa-wrench "></i></span>
                        <h2>Activity Preferences</h2>
                    </header><!-- widget div-->
                    <div>
                        <form id="form_empresa" method="post" action="/bo/admin/entorno_empresa" role="form"
                              class="smart-form">
                            <fieldset>
                                ...
                                <section id="usuario" class="col col-3">
                                    <label><h4>membership</h4>
                                        <input style="margin-left: 4rem;" type="checkbox"
                                               name="membresia" <?= $empresa[0]->membresia == 'ACT' ? "checked" : ""; ?> ></label>
                                </section>
                                <section id="usuario" class="col col-3">
                                    <label><h4>Packs</h4>
                                        <input style="margin-left: 4rem;" type="checkbox"
                                               name="paquete" <?= $empresa[0]->paquete == 'ACT' ? "checked" : ""; ?>></label>
                                </section>
                                <section id="usuario" class="col col-3">
                                    <label><h4>Items</h4>
                                        <input style="margin-left: 4rem;" type="checkbox"
                                               name="item" <?= $empresa[0]->item == 'ACT' ? "checked" : ""; ?> ></label>
                                </section>
                            </fieldset>

                            <fieldset>
                                <legend>Sponsored Referrals</legend>
                                <label style="margin: 1rem;width: 50rem;" class="select">
                                    <select id="afiliados_directos" name="afiliados_directos"
                            ...
                            <fieldset>
                                <legend>Points of commissions required on month</legend>
                                <label style="margin: 1rem;width: 10rem;" for="" class="input"><i
                                            class="icon-prepend fa fa-sort-numeric-asc"></i><input
                                            id="puntos_personales" class="form-control" name="puntos_personales"
                                            placeholder="" required="" type="number"
                                            value="<?= $empresa[0]->puntos_personales; ?>">
                                </label>
                            </fieldset>
