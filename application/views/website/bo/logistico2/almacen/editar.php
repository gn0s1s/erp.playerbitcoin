								...
								<tbody>
									...
									<tr>
										...
										<td class='text-center'>
											...
											<a class='txt-color-blue' style='cursor: pointer;' onclick='editar_cedi(<?php echo $row->id_cedi; ?>)' title='Edit'><i class='fa fa-pencil fa-3x'></i></a>
...
function estado_almacen(estatus, id)
{
	...
	function ValidarVacio(nombre, direccion, telefono){
		if(nombre == ''){
			...
			alert('The direction field of the cedi is required');
			return false;
		}else if(telefono == ''){
			alert('The cedi phone field is required');
			return false;
		}else{
			return true;
		}
