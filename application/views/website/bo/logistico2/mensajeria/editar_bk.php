        ...
        <div class="row">
            ...
            <div class="col col-xs-12 col-sm-6 col-lg-6">
                <label for="" class="input">Nombre
                    <input type="text" class="form-control" name="nommbre_contacto1" placeholder="Nombre of persona of contacto" class="form-control" value="<?php echo $contactos[1]->nombre; ?>" required />
                </label>
            </div>

            <div class="col col-xs-12 col-sm-6 col-lg-6">
                <label for="" class="input">Apellido
                    <input type="text" class="form-control" name="apellido_contacto1" placeholder="Apellido of persona of contacto" class="form-control" value="<?php echo $contactos[1]->apellido; ?>" required />
                </label>
            </div>
...
<?php } ?>
            ...
            <div class="col col-xs-12 col-sm-6 col-lg-6">
                ...
                <label for="" class="input">
                    ...
                    <input type="email" class="form-control" name="email_contacto1" placeholder="Email of the persona of contacto"class="form-control" value="<?php echo $contactos[1]->mail; ?>" required />
                </label>
            </div>
            <div class="col col-xs-12 col-sm-6 col-lg-6">
                <label for="" class="input">Puesto
                    <input type="text" class="form-control" name="puesto_contacto1" placeholder="Puesto of the persona of contacto" class="form-control" value="<?php echo $contactos[1]->puesto; ?>" />
                </label>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col col-xs-12 col-sm-6 col-lg-6">
                <label for="" class="input">Nombre
                    <input type="text" class="form-control" name="nommbre_contacto2" placeholder="Nombre of persona of contacto"class="form-control" value="<?php echo $contactos[0]->nombre; ?>" />
                </label>
            </div>

            <div class="col col-xs-12 col-sm-6 col-lg-6">
                <label for="" class="input">Apellido
                    <input type="text" class="form-control" name="apellido_contacto2" placeholder="Apellido of persona of contacto"class="form-control" value="<?php echo $contactos[0]->apellido; ?>" />
                </label>
            </div>
            <?php
...
<?php } ?>
            ...
            <div class="col col-xs-12 col-sm-6 col-lg-6">
                E-mail<label for="" class="input">
                    <i class="icon-prepend fa fa-envelope-o"></i>
                    <input type="email" class="form-control" name="email_contacto2" placeholder="Email of the persona of contacto" class="form-control" value="<?php echo $contactos[0]->mail; ?>" />
                </label>
            </div>

            <div class="col col-xs-12 col-sm-6 col-lg-6">
                Puesto<label for="" class="input">
                    <input type="text" class="form-control" name="puesto_contacto2" placeholder="Puesto of the persona of contacto"class="form-control" value="<?php echo $contactos[0]->puesto; ?>" />
                </label>
            </div>
        </div>
