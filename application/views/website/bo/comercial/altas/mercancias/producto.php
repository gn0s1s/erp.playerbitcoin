						...
						<div class="widget-body">
							<form method="POST" enctype="multipart/form-data"
									...
									<div id="form_mercancia">
										<div class="row">
											<fieldset>
												...
												<section class="col col-2">
													<label class="input"> Código of barras <input type="number"
										...
										<div class="row">
											<fieldset>
												...
												<small><cite title="Source Title">Para ver the archivo que va
														a cargar, pulse con the puntero on the boton of "Buscar"</cite></small>
												</section>
												<section class="col col-2">
												...
												<section class="col col-2">
													<label class="input"><span id="labelextra"><b>Mínimo of Inventario</b></span> <input required id="inventario"
								...
								<fieldset id="moneda_field">
									...
									<section class="col col-2">
										<label class="input"> Cantidad mínima of venta <input
											type="number" name="min_venta" min="1" id="min_venta"
											required>
										</label>
									</section>
									<section class="col col-2">
										<label class="input"> Cantidad máxima of venta <input
									...
									<fieldset>
										<div class="row" id="impuesto_agregar">
											...
											<section class="col col-2">
												Country of the mercancía <label class="select"> <select
...
/*$('.canal').each(function() {
		// es the valor del checkbox correspondiente
		if($(this).val()==1){
			$(this).hide();
		}
});*/
