                        ...
                        <div>
                            <div class="row col-xs-12 col-md-12 col-sm-12 col-lg-12 pull-right">
                                ...
                                <div class="col-xs-4 col-md-1 col-sm-2 col-lg-1">
                                    <center>
                                        <a title="Recargar" style="cursor: pointer;" class="txt-color-gray"
                                           href="red_tabla"><i class="fa fa-spinner fa-3x"></i></a>
                                        <br>Recargar
                                    </center>
                                </div>
                                ...
                                <div class="col-xs-4 col-md-1 col-sm-2 col-lg-1">
                                    <center>
                                        <a title="Bloquear" class="txt-color-gray"><i
                                                    class="fa fa-unlock fa-3x"></i></a>
                                        <br>Bloquear
                                    </center>
                                </div>
                                <div class="col-xs-4 col-md-1 col-sm-2 col-lg-1">
                                    <center>
                                        <a title="Desbloquear" class="txt-color-gray"><i
                                                    class="fa fa-lock fa-3x"></i></a>
                                        <br>Desbloquear
                                    </center>
                                </div>
                                ...
                                <div class="col-xs-4 col-md-1 col-sm-2 col-lg-1">
                                    <center>
                                        <a title="Arbol 1" class="txt-color-gray"><i
                                                    class="fa fa-sitemap fa-3x"></i></a>
                                        <br>Tree 1
                                    </center>
                                </div>
                                ...
                                <div class="col-xs-4 col-md-1 col-sm-2 col-lg-1">
                                    <center>
                                        <a title="Arbol 2" class="txt-color-green"><i
                                                    class="fa fa-sitemap fa-3x"></i></a>
                                        <br>Tree 2
                                    </center>
                                </div>
                                ...
                                <div class="col-xs-4 col-md-1 col-sm-2 col-lg-1">
                                    <center>
                                        <a title="Eliminar" style="cursor: pointer;" class="txt-color-red"><i
                            ...
                            <form name="formulario" action="/bo/comercial/actualizar_tabla" method="post"
                                ...
                                <div class="row col-xs-11 col-md-4 col-sm-4 col-lg-2 smart-form"
                                     style="padding-left: 6.8%;">
                                    <br>
                                    <br>
                                    ...
                                    <section style="width: 100%;">
                                        Campos of Busqueda
                                        <label class="select">
                                            <select name="campos_de_busqueda" id="campos_de_busqueda"
                                                    onChange="Activar_Casilla()">
                                                <option value='---'> ---
                                ...
                                <div class="row col-xs-12 col-md-12 col-sm-12 col-lg-12">
                                    ...
                                    <section style="width: 100%; padding-left: 1%;">
                                        ...
                                        <label class="input col col-xs-12 col-sm-6 col-md-6 col-lg-2">Id
                                            <input class="form-control" name="id_buscado" id="id_buscado" type="text"
                                                   disabled>
                                        </label>

                                        <label class="input col col-xs-12 col-sm-6 col-md-6 col-lg-2">Nombre o Apellido
                                            <input class="form-control" name="nombre_buscado" id="nombre_buscado"
                                                   type="text" disabled="disabled">
                                        </label>

                                        <label class="input col col-xs-12 col-sm-6 col-md-6 col-lg-2">Apellido
                                            <input class="form-control" name="apellido_buscado" id="apellido_buscado"
                                                   type="text" disabled="disabled">
                                        </label>

                                        <label class="input col col-xs-12 col-sm-6 col-md-6 col-lg-2">Username
                                            <input class="form-control" name="username_buscado" id="username_buscado"
                                                   type="text" disabled="disabled">
                                        </label>

                                        <label class="input col col-xs-12 col-sm-6 col-md-6 col-lg-2">e-mail
                                            <input class="form-control" name="email_buscado" id="email_buscado"
                                                   type="text" disabled="disabled">
                                        </label>

                                        <label class="input col col-xs-12 col-md-12">
                                        </label>
                                        <button type="submit" class="hide" style="margin-right: 4.5%;" id="buscar"
                            ...
                            <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
                                ...
                                <tr>
                                    <th>ID</th>
                                    <th data-class="expand">Profile Photo</th>
                                    <th data-hide="phone">User</th>
                                    <th data-hide="phone,tablet">Sponsor</th>
                                    <th data-hide="phone,tablet">Password</th>
                                    <th data-hide="phone,tablet">Registry Date</th>
                                    <th data-hide="phone,tablet">VIP ?</th>
                                    <th data-hide="phone,tablet">PSR ?</th>
                                ...
                                <?php foreach ($afiliados as $afiliado) { ?>
                                    <tr>
                                        ...
                                        <td><img style="width: 10rem; height: 10rem;"
                                                 src="<?php echo $afiliados_imagen ?>"></img></td>
                                        <td><?php echo $afiliado->nombre . " "
                                                . $afiliado->apellido
                                                . " (" . $afiliado->username . ")<br/>". $afiliado->email  ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a title="Billetera" style='cursor: pointer;'
                                               onclick="billetera_afiliado(<?php echo $afiliado->id; ?>)"
                                               class="txt-color-green">
                                                <i class="fa fa-money fa-3x"></i></a>
                                            <a title="Eliminar" style='cursor: pointer;'
                                               onclick="eliminar_afiliado(<?php echo $afiliado->id; ?>)"
                                               class="txt-color-red">
...
<script type="text/javascript">
    ...
    function Actualizar_Tabla() {
        ...
        if (document.formulario.id_buscado.disabled == true) {
            id_buscado = '';
        }
        if (document.formulario.nombre_buscado.disabled == true) {
            nombre_buscado = '';
        }
        if (document.formulario.apellido_buscado.disabled == true) {
            apellido_buscado = '';
        }
        if (document.formulario.username_buscado.disabled == true) {
            username_buscado = '';
        }
        if (document.formulario.email_buscado.disabled == true) {
            email_buscado = '';
        }
